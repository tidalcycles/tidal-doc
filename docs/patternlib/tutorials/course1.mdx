...
[the next part](course2.mdx) the remaining.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-1-lesson-1-tidal-interaction), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-1-lesson-2-loading-sample-packs/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-1-lesson-3-sequencing-with-the-mini-notation/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-1-lesson-4-mini-notation-part-2/), as there is a lot of additional information there.


### Lesson 5: mini-notation (part III)

<YouTube id="aD-35W7rnFM" />

In which I find out I really can't say the word "mininotation"..

This video is a few things lumped together - a run through the tasks on the last worksheet, how to upgrade tidal, and finally how to use the "Euclidean notation".
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/c/course/week1/16), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-2-lesson-1-starting-out-with-effects/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-2-lesson-2-manipulating-time-with-setcps-cps-patterns-and-fast-slow-functions/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-2-lesson-3-combining-patterns-with-arithmetic-plus-the-hurry-function/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-3-lesson-1-exploring-the-every-function-including-tackling-the-meaning-of/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-3-lesson-2-cut-vs-legato/), as there is a lot of additional information there.
-----
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-3-lesson-3-slice-and-splice/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-3-lesson-4-chop-and-striate/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-4-lesson-1-continuous-patterns-sine-square-tri-saw-and-random-functions/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-4-lesson-2-random-marathon-rand-irand-mininotation-randomness-scramble-shuffle-choose-more/), as there is a lot of additional information there.
...
Always remember to check the [forum page for the lesson](https://club.tidalcycles.org/t/week-4-lesson-3-random-marathon-part-2-randcat-stripe-degrade-sometimes-somecycles-randslice-more/), as there is a lot of additional information there.
